...
public class _GNextGreaterElementI {
	...
	public static void main(String[] args) {
		...
		System.out.println(Arrays.toString(nextGreaterElement(findNums1, nums1)));
	}
}
 ...
 * output -1.
 * 
 * Note: All elements in nums1 and nums2 are unique. The length of both nums1
