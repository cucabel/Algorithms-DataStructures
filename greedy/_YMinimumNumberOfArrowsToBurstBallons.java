...
public class _YMinimumNumberOfArrowsToBurstBallons {
 ...
 * space. For each balloon, provided input is the start and end coordinates of
 ...
 * 
 * So first of all, we shoot at position 4, we go through the array and see that
 * all first 4 balloons can be taken care of by this single shot. Then we need
 * another shot for one last balloon. So the result should be 2.
 * 
 */
